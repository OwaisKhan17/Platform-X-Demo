...
import SuccessAnimation from "./../animations/CheckMark.json";
        ...
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-[600px] p-5 lg:p-10">
            <div className="text-center">
                <div className="relative flex items-center justify-center z-1 mb-7">
                    {type === "success" ?
                        <Lottie animationData={SuccessAnimation} loop={true} style={{ height: "150px", width: "150px" }} />
                        : type === "error" ?
                            <Lottie lottieRef={lottieRef} animationData={ErrorAnimation} loop={true} style={{ height: "150px", width: "150px" }} />
                            : <>
                                <svg
                                    className={cn(theme.bg)}
                                    width="90"
                                    height="90"
                                    viewBox="0 0 90 90"
                                    fill="none"
