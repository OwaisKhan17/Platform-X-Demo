...
const AppHeader: React.FC = () => {
  ...
  return (
    <div className="py-2 px-4 mx-auto max-w-(--breakpoint-2xl) md:p-6 md:py-2">
      <header className="sticky rounded-2xl mb-0 py-0 mt-[16px] top-0 flex w-full bg-white border border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
